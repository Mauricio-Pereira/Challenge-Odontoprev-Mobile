        ...
        >
          ...
          <View style={styles.bigCard}>
            <Text style={styles.bigCardText}>
              Tenha acesso a todos os procedimentos solicitados para você na
              palma da mão.
            </Text>
